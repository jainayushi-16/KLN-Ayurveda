...
export default function Hero() {
    ...
    return (<section className="bg-main-bg">
      <div className="hero-container">
        ...
        {isTablet ? (<>
            {isMobile && (<Image src={"videos/hero2.mp4"} alt="hero-image" height={1000} width={1000} className="absolute bottom-50 left-1/2 -translate-x-1/2 object-auto scale-200 md:scale-300 w-120"/>)}
            <Image src={"videos/hero2.mp4"} alt="hero-image" height={1000} width={1000} className="absolute top-110 md:top-130 left-1/2 -translate-x-1/2 object-auto scale-100 md:scale-150 w-120"/>
