      ...
      <div className="container mx-auto relative z-10 px-5">
        <div className="col-center">
          ...
          <div className="mt-16 col-center">
            <ClipPathTitle title={t("home.benefit1", {}, "Hair Growth")} color={"#faeade"} bg={"#2F5D34"} className={"first-title"} borderColor={"#222123"} />
            <ClipPathTitle title={t("home.benefit2", {}, "Reduces Hair Fall")} color={"#222123"} bg={"#E7F0E4"} className={"second-title"} borderColor={"#222123"} />
            <ClipPathTitle title={t("home.benefit3", {}, "Nourishes Scalp")} color={"#faeade"} bg={"#5B7C3A"} className={"third-title"} borderColor={"#222123"} />
            <ClipPathTitle title={t("home.benefit4", {}, "Root Strengthening")} color={"#2E2D2F"} bg={"#C9A66B"} className={"fourth-title"} borderColor={"#222123"} />
          </div>
          <div className="mt-12">
            <p className="text-milk/80 font-paragraph text-center text-base md:text-lg tracking-wider animate-pulse">
              {t("home.benefitMore", {}, "And much more ...")}
            </p>
          </div>
        </div>
      </div>
