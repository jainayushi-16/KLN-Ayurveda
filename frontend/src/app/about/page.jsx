...
export default function AboutPage() {
    useGSAP(() => {
        ...
        gsap.from(".about-story-section, .about-card", {
            y: 40,
            opacity: 0,
            scale: 0.96,
            filter: "blur(8px)",
    ...
    return (<main className="min-h-screen w-full relative overflow-hidden bg-gradient-to-b from-[#F7F4EC] via-[#E8F2E3] to-[#F7F4EC] text-[#222123]">
      {/* Homepage Sticky Navbar */}
      <NavBar />

      {/* 1. Hero Section */}
      <section className="relative min-h-[90vh] flex items-center justify-center pt-32 pb-20 px-6 md:px-12 lg:px-16 overflow-hidden">
        {/* Background Image */}
        <Image src="/images/products/hairoil/oilbenefit.jpeg" alt="KLN Ayurveda Heritage" fill priority sizes="100vw" className="object-cover object-center opacity-25"/>
        <div className="absolute inset-0 bg-gradient-to-b from-[#F7F4EC]/80 via-[#E8F2E3]/90 to-[#F7F4EC]"/>

        <div className="relative z-10 max-w-4xl mx-auto text-center about-hero-text">
          <span className="inline-block px-5 py-2 rounded-full bg-white/80 backdrop-blur-md border border-[#2F5D34]/20 text-[#2F5D34] text-xs md:text-sm font-bold uppercase tracking-widest mb-6 shadow-sm">
          ...
          <p className="text-gray-700 font-paragraph text-base md:text-2xl mt-6 leading-relaxed max-w-2xl mx-auto">
            Honoring 5,000-year-old Vedic wisdom through pure, uncompromised botanical hair and skin remedies.
          </p>

          <div className="mt-10">
            <Link href="/shop">
              <button className="px-10 py-5 rounded-full bg-[#2F5D34] text-white text-xs md:text-sm font-bold uppercase tracking-widest shadow-xl hover:bg-[#224426] hover:scale-105 active:scale-95 transition-all">
      ...
      <section className="py-24 w-full px-6 md:px-12 lg:px-16 relative z-10 about-story-section">
        <div className="max-w-[1700px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          {/* Left Image Card */}
          <div className="relative h-[400px] sm:h-[500px] rounded-[3rem] overflow-hidden shadow-2xl border border-white/80">
            <Image src="/images/products/hairoil/oilbenefit.jpeg" alt="Ayurvedic Preparation" fill className="object-cover object-center"/>
          </div>

          {/* Right Content */}
          <div>
            <span className="text-xs font-bold uppercase tracking-widest text-[#5B7C3A] bg-white/80 px-4 py-1.5 rounded-full border border-[#5B7C3A]/20 inline-block mb-4">
              Our Genesis
            </span>
      ...
      {/* 3. Mission & Vision */}
      <section className="py-16 w-full px-6 md:px-12 lg:px-16 relative z-10">
        <div className="max-w-[1700px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="about-card bg-white/85 backdrop-blur-md p-10 rounded-[2.5rem] border border-white/80 shadow-xl">
      ...
      <section className="py-20 w-full px-6 md:px-12 lg:px-16 relative z-10">
        <div className="max-w-[1700px] mx-auto">
          <div className="text-center max-w-2xl mx-auto mb-14">
            <span className="text-xs font-bold uppercase tracking-widest text-[#5B7C3A] bg-white/80 px-4 py-1.5 rounded-full inline-block mb-3 border border-[#5B7C3A]/20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((v, i) => (<div key={i} className="about-card bg-white/80 backdrop-blur-md p-8 rounded-3xl border border-white/80 shadow-lg flex flex-col items-center text-center group hover:-translate-y-2 transition-all duration-500">
                ...
                <h3 className="text-xl font-bold text-[#222123] mb-3">
                  {v.title}
                </h3>
      ...
      <section className="py-24 bg-[#E7F0E4]/60 w-full px-6 md:px-12 lg:px-16 relative z-10 timeline-container">
        <div className="max-w-[1700px] mx-auto">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <span className="text-xs font-bold uppercase tracking-widest text-[#2F5D34] bg-white px-4 py-1.5 rounded-full inline-block mb-3 border border-[#2F5D34]/20">
              From Seed to Bottle
            </span>
            <h2 className="text-3xl md:text-5xl font-bold text-[#222123]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-6 relative">
            {manufacturingTimeline.map((step, idx) => (<div key={idx} className="timeline-step bg-white/90 backdrop-blur-md p-6 rounded-3xl border border-white shadow-md flex flex-col justify-between text-center group hover:-translate-y-2 transition-all duration-500">
                <div>
                  <span className="size-10 rounded-full bg-[#2F5D34] text-white text-xs font-bold flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
                    {step.step}
                  </span>
                  <h4 className="text-lg font-bold text-[#222123] mb-2">
                    {step.name}
                  </h4>
      ...
      <section className="py-20 w-full px-6 md:px-12 lg:px-16 relative z-10">
        <div className="max-w-[1700px] mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {certifications.map((cert, idx) => (<div key={idx} className="about-card bg-white/80 backdrop-blur-md p-8 rounded-3xl border border-white/80 shadow-md text-center">
      ...
      {/* 7. Why Choose KLN */}
      <section className="py-20 bg-white/50 w-full px-6 md:px-12 lg:px-16 relative z-10">
        <div className="max-w-[1700px] mx-auto">
          <div className="text-center max-w-2xl mx-auto mb-14">
            <span className="text-xs font-bold uppercase tracking-widest text-[#5B7C3A] bg-white px-4 py-1.5 rounded-full inline-block mb-3 border border-[#5B7C3A]/20">
              Unrivaled Quality
            </span>
            <h2 className="text-3xl md:text-5xl font-bold text-[#222123]">
              Why Choose KLN
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {whyChooseUs.map((w, i) => (<div key={i} className="about-card bg-white/85 backdrop-blur-md p-8 rounded-3xl border border-white shadow-md flex items-start gap-4">
      ...
      <section className="py-20 w-full px-6 md:px-12 lg:px-16 relative z-10">
        <div className="max-w-[1700px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {teamMembers.map((t, idx) => (<div key={idx} className="about-card bg-white/80 backdrop-blur-md p-8 rounded-3xl border border-white shadow-lg text-center">
                <div className="size-20 rounded-full bg-[#E7F0E4] flex items-center justify-center text-4xl mx-auto mb-4">
                  {t.avatar}
                </div>
                <h4 className="text-xl font-bold text-[#222123] mb-1">
                  {t.name}
                </h4>
      ...
      {/* 9. Achievements */}
      <section className="py-16 bg-[#2F5D34] text-white w-full px-6 md:px-12 lg:px-16 relative z-10">
        <div className="max-w-[1700px] mx-auto grid grid-cols-2 lg:grid-cols-4 gap-8 text-center">
          {achievements.map((a, i) => (<div key={i} className="p-6">
      ...
      <section className="py-24 w-full px-6 md:px-12 lg:px-16 relative z-10 text-center">
        <div className="max-w-4xl mx-auto bg-white/80 backdrop-blur-xl p-12 sm:p-16 rounded-[3rem] border border-white shadow-2xl">
          <span className="text-xs font-bold uppercase tracking-widest text-[#5B7C3A] bg-[#E7F0E4] px-4 py-1.5 rounded-full inline-block mb-4">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="/shop">
              <button className="px-10 py-4.5 rounded-full bg-[#2F5D34] text-white font-bold text-xs sm:text-sm uppercase tracking-widest shadow-xl hover:bg-[#224426] hover:scale-105 active:scale-95 transition-all">
                Shop Now
              </button>
            </Link>
            <Link href="/shop">
              <button className="px-10 py-4.5 rounded-full border-2 border-[#2F5D34] text-[#2F5D34] hover:bg-[#2F5D34] hover:text-white font-bold text-xs sm:text-sm uppercase tracking-widest transition-all">
                Contact Us
              </button>
            </Link>
          </div>
