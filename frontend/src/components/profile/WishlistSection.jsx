    ...
    <div className="bg-white/90 backdrop-blur-xl border border-[#2F5D34]/15 rounded-3xl p-6 sm:p-8 shadow-xl">
      ...
      <div className="flex items-center justify-between border-b border-gray-100 pb-5 mb-6">
        <div>
          ...
          <p className="text-xs sm:text-sm text-gray-500 font-paragraph mt-1">
            {t("profilePage.wishlistDesc", {}, "Your saved favorite herbal formulations and personal care kits.")}
          </p>
        </div>
      ...
      {wishlistItems.length === 0 ? (
        <div className="text-center py-16 bg-gray-50/80 rounded-2xl border border-dashed border-gray-300">
          ...
          >
            {t("profilePage.exploreShop", {}, "Explore Shop")}
          </button>
        </div>
      ) : (
              ...
              >
                ...
                <div className="p-4 pt-0 flex gap-2">
                  ...
                  >
                    ...
                    <span>{t("profilePage.moveToCart", {}, "Cart")}</span>
                  </button>
                  <button
                  ...
                  >
                    ...
                    <span>{t("profilePage.buyNow", {}, "Buy Now")}</span>
                  </button>
                </div>
              </div>
            );
